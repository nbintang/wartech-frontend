...
function CardChart() {
  ...
  return (
    <Card
      className={cn(
        "rounded-none border-none h-[500px] md:h-[480px] pb-0 flex flex-col"
      )}
    >
      <CardHeader className="flex-shrink-0 pb-4">
        <CardTitle className="text-2xl font-bold">User Statistic</CardTitle>
        <CardDescription>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores eum
          ex incidunt. Lorem ipsum dolor sit.
        </CardDescription>
      </CardHeader>
