...
export default function Profile() {
  ...
  const setOpenDialog = useHandleImageDialog((state) => state.setOpenDialog);
  ...
  return (
    <>
      <div className="grid place-items-center w-full  min-h-screen mx-auto">
        <div>
          ...
          <div className="flex flex-col mx-5 gap-4 mt-4">
            ...
            <Separator />
            <UserProfileDasboard profile={profile} />
          </div>
        </div>
      </div>
    </>
